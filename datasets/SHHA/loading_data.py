...
def loading_data():
    ...
    train_set = SHHA(os.path.join(cfg_data.DATA_PATH, 'train_data'), 'train', main_transform=train_main_transform,
    ...
    val_set = SHHA(os.path.join(cfg_data.DATA_PATH, 'test_data'), 'test', main_transform=None,
                   img_transform=img_transform, gt_transform=gt_transform)
